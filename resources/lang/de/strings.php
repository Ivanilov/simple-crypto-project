...
return [
    ...
    */
    ...
    'backend'   => [
        ...
        'welcome'   => <<<'TEXT'
<p>Dies ist das CoreUI theme von <a href="https://coreui.io/" target="_blank">creativeLabs</a>. Dies ist eine abgestufte Version mit nur den nötigsten Styles und Scripten, damit es läuft. Lade die Vollversion herunter, um Komponenten zum Dashboard hinzufügen zu können.</p>

...
return [
    ...
    */
    ...
    'backend'   => [
        ...
        'welcome'   => <<<'TEXT'
<p>Dette er temaet CoreUI som er udviklet af <a href="https://coreui.io/" target="_blank">creativeLabs</a>. Dette er en skrabet udgave med kun det nødvendige design og kode for at få det hele til at fungere. Download den fulde version for at tilføje flere komponenter til dit betjeningspanel.</p>

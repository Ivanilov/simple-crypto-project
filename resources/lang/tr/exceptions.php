    ...
    'frontend'  => [
        'auth'  => [
            'confirmation'          => [
                ...
                'resend'            => 'Hesabınız doğrulanmadı. Lütfen e-postanızdaki onay bağlantısını tıklayın veya onay e-postasını yeniden göndermek için <a href="http://boilerplate.dev/account/confirm/resend/:user_uuid">buraya tıklayın</a>',

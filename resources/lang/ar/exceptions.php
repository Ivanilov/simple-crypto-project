    ...
    'frontend'  => [
        'auth'  => [
            'confirmation'          => [
                ...
                'resend'            => 'حسابك غير مفعل. برجاء الضغط على رابط التفعيل الذي تم إرساله إلى بريدك الإلكتروني, أو <a href="http://boilerplate.dev/account/confirm/resend/:user_uuid">إضغط هنا</a> لإعادة إرسال رابط التفعيل مجددا.',

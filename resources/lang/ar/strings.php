...
return [
    ...
    */
    ...
    'backend'   => [
        ...
        'welcome'   => <<<'TEXT'
<p>هذا هو ثيم CoreUI المصمم من قبل <a href="https://coreui.io/" target="_blank">creativeLabs</a>. هذه مجرد نسخة جردت من الكثير من الأشياء وتركت فقط ال Styles وال Scripts التي تجعلها تعمل بأقل الإمكانيات. يجب عليك تحميل النسخة الكاملة حتى تستطيع إضافة المكونات للوحة تحكمك.
</p>

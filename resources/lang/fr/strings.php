...
return [
    ...
    */
    ...
    'backend'   => [
        ...
        'welcome'   => <<<'TEXT'
<p>Le thème CoreUI est créé par <a href="https://coreui.io/" target="_blank">creativeLabs</a>. Ceci est une version allégée avec seulement les styles et les scripts nécessaires pour le faire fonctionner. Téléchargez la version complète pour commencer à ajouter des composants à votre tableau de bord.</p>

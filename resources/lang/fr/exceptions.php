    ...
    'frontend'  => [
        'auth'  => [
            'confirmation'          => [
                ...
                'resend'            => 'Votre compte n\'est pas confirmé. Veuillez utiliser le lien qui vous a été envoyé par email, ou <a href="http://boilerplate.dev/account/confirm/resend/:user_uuid">cliquez ici </a> pour recevoir un nouvel email.',

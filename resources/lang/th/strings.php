...
return [
    ...
    */
    ...
    'backend'   => [
        ...
        'welcome'   => <<<'TEXT'
<p>นี่คือธีม CoreUI โดย <a href="https://coreui.io/" target="_blank">creativeLabs</a> ซึ่งเป็นเวอร์ชั่นตัดทอน เหลือสไตล์ชีทและสคริปต์ที่จำเป็น คุณสามารถดาวน์โหลดเวอร์ชั่นเต็มเพิ่มเติม เพื่อเพิ่มคอมโพเนนท์ให้กับแผงควบคุม</p>

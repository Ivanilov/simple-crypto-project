...
@section ('page-title')
    <span class="text-semibold">Log Viewer</span> - {{ __('menus.backend.log-viewer.logs') }}
@endsection
...
@section('content')
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">{{ __('menus.backend.log-viewer.logs') }}
                <a class="heading-elements-toggle"><i class="icon-more"></i></a>
            </h5>
        </div>

        <div class="panel-body table-log-viewer">
                            ...
                            <tr>
                                @foreach($row as $key => $value)
                                    <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                        @if ($key == 'date')
                                            <a href="{{ route('log-viewer::logs.show', [$value]) }}" class="btn btn-xs btn-primary">
                                                {{ $value }}
                                            </a>
                                        @elseif ($value == 0)
                                ...
                                @endforeach
                                <td class="text-right">
                                    <div class="btn-group btn-group-xs" role="group" aria-label="Log Viewer Actions">
                                        ...
                                        <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-backdrop="false" data-target="#delete-log-modal" data-log-date="{{ $date }}">

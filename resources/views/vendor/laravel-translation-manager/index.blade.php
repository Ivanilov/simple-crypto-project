            ...
            @endif
                <div class="col-sm-3 pull-right">
                    <div class="input-group-sm">
                        ...
                        <select name="p" id="primary-locale" class="select">
                ...
                <div class="col-sm-3 pull-right">
                    <div class="input-group-sm">
                        ...
                        <select name="t" id="translating-locale" class="select">
                            @foreach($locales as $locale)
                ...
                <div class="col-sm-3 pull-right">
                    <div class="input-group-sm">
                        ...
                        <select name="l" id="interface-locale" class="select">
                            @foreach($locales as $locale)
...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">@lang($package . '::messages.translation-manager')</h5>
            <div class="heading-elements">
                <div class="input-group-sm">
                    @foreach($locales as $locale)
                        <?php $isLocaleEnabled = str_contains($userLocales, ',' . $locale . ','); ?>
                        <div class="checkbox-inline checkbox-switchery switchery-xs">
                            <label>
                                <input <?= $locale !== $primaryLocale && $locale !== $translatingLocale ? ' class="display-locale switchery" ' : ' class="switchery' ?> name="d[]"
                                       type="checkbox"
                                       value="<?=$locale?>"
                                    ...
                                    <form id="form-import-all" class="form-import-all" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group-sm">
                                                    <select name="replace" class="import-select form-control select">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group-sm">
                                            <?= Form::select('group', $groups, $group, array(
                                                'form' => 'form-select', 'class' => 'group-select form-control select'
                                            )) ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">

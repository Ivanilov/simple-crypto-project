...
@section ('title', __('labels.backend.access.users.deactivated') . ' | ' . __('labels.backend.access.users.management'))


@section ('page-title')
    <span class="text-semibold">{{ __('labels.backend.access.users.management') }}</span> - {{ __('labels.backend.access.users.deactivated') }}
@endsection

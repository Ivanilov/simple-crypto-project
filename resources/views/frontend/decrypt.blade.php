...
@section('title', app_name() . ' | Расшифрование')

@section('content')
    <div class="content d-flex justify-content-center align-items-center">
        <!-- Registration form -->
    {{ html()->form('POST', route('frontend.encryption.decrypt'))->class('flex-fill')->acceptsFiles()->open() }}
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            <h5 class="mb-0">Расшифровать архив</h5>
                        ...
                        <button type="submit"  class="btn bg-teal-400 btn-labeled btn-labeled-right"><b><i class="icon-plus3"></i></b>Получить файл</button>
                        {{ html()->form()->close() }}
                    </div>
                </div>
            </div>

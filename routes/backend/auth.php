...
Route::group([
    ...
    Route::group([
        'middleware' => 'permission:Full access',
    ], function () {
        /*
         * User Management
         */
        Route::group(['namespace' => 'User'], function () {
            ...
            Route::group(['prefix' => 'user/{user}'], function () {
                ...
                // Avatar
                Route::post('avatar/upload', 'AvatarController@upload')->name('user.avatar.upload');
                Route::post('avatar/remove', 'AvatarController@remove')->name('user.avatar.remove');
            });
